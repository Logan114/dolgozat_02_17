...
public class IdomokTest {
    FaIdomokProgram idom;

    @Test
    void testAbstract() throws NoSuchMethodException {
        Class<?> clazz = FaIdomokProgram.class;
        assertTrue(Modifier.isAbstract(clazz.getModifiers()), "A 'FaIdomokProgram' osztály legyen abstract.");
    ...
    @Test
    void testFajsuly(){
        assertEquals(0.8, FaIdomokProgram.getFajsuly());
    }
